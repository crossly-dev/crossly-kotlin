...
------------ | ------------- | ------------- | -------------
**platformListings** | [**kotlin.collections.List&lt;GetListingResponsePlatformListings&gt;**](GetListingResponsePlatformListings.md) |  | 
**id** | **kotlin.String** |  | 
...
**floorIsNet** | **kotlin.Boolean** |  | 
**status** | **kotlin.String** |  | 
**source** | **kotlin.String** |  | 
**isBundle** | **kotlin.Boolean** |  | 
**automationAssignedRuleIds** | **kotlin.collections.List&lt;kotlin.String&gt;** |  | 
...
**priceFloorCents** | [**java.math.BigDecimal**](java.math.BigDecimal.md) |  |  [optional]
...
**gradeKey** | **kotlin.String** |  |  [optional]
**grading** | [**ListListingsItemGrading**](ListListingsItemGrading.md) |  |  [optional]
**publishAt** | [**java.time.OffsetDateTime**](java.time.OffsetDateTime.md) |  |  [optional]
**scheduledPlatforms** | **kotlin.collections.List&lt;kotlin.String&gt;** |  |  [optional]
**parentListingId** | **kotlin.String** |  |  [optional]
**hsCode** | **kotlin.String** |  |  [optional]
**countryOfOrigin** | **kotlin.String** |  |  [optional]
...
**duplicateOfListingId** | **kotlin.String** |  |  [optional]
**clientDraftId** | **kotlin.String** |  |  [optional]
