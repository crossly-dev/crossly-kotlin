package net.crossly.buyer.infrastructure
...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        const val baseUrlKey = "net.crossly.buyer.baseUrl"
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            // return tempfile
            val f = java.nio.file.Files.createTempFile("tmp.net.crossly.buyer", null).toFile()
            f.deleteOnExit()
