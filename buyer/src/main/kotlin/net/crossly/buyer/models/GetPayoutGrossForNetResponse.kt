...
import net.crossly.buyer.models.GetPayoutGrossForNetResponseEstimate
...
data class GetPayoutGrossForNetResponse (

    @Json(name = "grossCents")
    val grossCents: java.math.BigDecimal,

    @Json(name = "estimate")
    val estimate: GetPayoutGrossForNetResponseEstimate
