 ...
 * @param sales 
 * @param refunds 
 * @param mileageEntries 
 */

data class GetTaxScheduleCResponseCounts (

    @Json(name = "sales")
    val sales: java.math.BigDecimal,

    @Json(name = "refunds")
    val refunds: java.math.BigDecimal,

    @Json(name = "mileageEntries")
    val mileageEntries: java.math.BigDecimal
