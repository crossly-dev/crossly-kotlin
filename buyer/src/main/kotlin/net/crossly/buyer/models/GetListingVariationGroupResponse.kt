...
import net.crossly.buyer.models.GetListingVariationGroupResponseGroup
...
data class GetListingVariationGroupResponse (

    @Json(name = "group")
    val group: GetListingVariationGroupResponseGroup? = null
