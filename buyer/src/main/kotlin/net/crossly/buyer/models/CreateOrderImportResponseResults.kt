 ...
 * @param platform 
 * @param ok 
 * @param accountsStarted Cookie track: number of account slots kicked off. API track: always 1.
 */

data class CreateOrderImportResponseResults (
    ...
    @Json(name = "accountsStarted")
    val accountsStarted: java.math.BigDecimal? = null
