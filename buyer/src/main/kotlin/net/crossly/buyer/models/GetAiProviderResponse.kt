...
import net.crossly.buyer.models.GetAiProviderResponseProviders
...
data class GetAiProviderResponse (

    @Json(name = "providers")
    val providers: kotlin.collections.List<GetAiProviderResponseProviders>
