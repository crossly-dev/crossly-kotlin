...
import net.crossly.buyer.models.GetAnalyticByPlatformResponseBreakdown
...
data class GetAnalyticByPlatformResponse (

    @Json(name = "days")
    val days: java.math.BigDecimal,

    @Json(name = "breakdown")
    val breakdown: kotlin.collections.List<GetAnalyticByPlatformResponseBreakdown>
