...
import net.crossly.buyer.models.CreateListingByIdResponseItems
...
data class CreateListingByIdResponse (

    @Json(name = "items")
    val items: kotlin.collections.List<CreateListingByIdResponseItems>
