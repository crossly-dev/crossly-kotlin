...
import net.crossly.buyer.models.GetTaxonomyCategoryAspectResponseAspects
...
data class GetTaxonomyCategoryAspectResponse (

    @Json(name = "aspects")
    val aspects: kotlin.collections.List<GetTaxonomyCategoryAspectResponseAspects>
