...
import net.crossly.buyer.models.GetTaxonomyCategoryResponseCategories
...
data class GetTaxonomyCategoryChildrenResponse (

    @Json(name = "children")
    val children: kotlin.collections.List<GetTaxonomyCategoryResponseCategories>
