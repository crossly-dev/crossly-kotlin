...
import net.crossly.buyer.models.GetAnalyticTimeseryResponseSeries
...
data class GetAnalyticTimeseryResponse (

    @Json(name = "days")
    val days: java.math.BigDecimal,

    @Json(name = "series")
    val series: kotlin.collections.List<GetAnalyticTimeseryResponseSeries>
