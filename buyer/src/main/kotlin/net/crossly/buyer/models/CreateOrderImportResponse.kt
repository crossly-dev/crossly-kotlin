...
import net.crossly.buyer.models.CreateOrderImportResponseResults
...
data class CreateOrderImportResponse (

    @Json(name = "results")
    val results: kotlin.collections.List<CreateOrderImportResponseResults>
