...
import net.crossly.buyer.models.CreatePlatformAccountRefreshStatusResponseResults
...
data class CreatePlatformAccountRefreshStatusResponse (

    @Json(name = "results")
    val results: kotlin.collections.List<CreatePlatformAccountRefreshStatusResponseResults>
