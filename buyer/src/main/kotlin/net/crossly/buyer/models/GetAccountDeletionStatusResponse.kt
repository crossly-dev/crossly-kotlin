...
import net.crossly.buyer.models.GetAccountDeletionStatusResponsePending
...
data class GetAccountDeletionStatusResponse (

    @Json(name = "pending")
    val pending: GetAccountDeletionStatusResponsePending
