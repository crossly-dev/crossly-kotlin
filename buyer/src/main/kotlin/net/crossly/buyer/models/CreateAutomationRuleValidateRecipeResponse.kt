...
import net.crossly.buyer.models.CreateAutomationRuleValidateRecipeResponseDetails
...
data class CreateAutomationRuleValidateRecipeResponse (
    ...
    @Json(name = "details")
    val details: CreateAutomationRuleValidateRecipeResponseDetails
