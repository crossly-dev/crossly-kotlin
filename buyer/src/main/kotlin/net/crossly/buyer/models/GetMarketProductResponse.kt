...
import net.crossly.buyer.models.GetMarketProductResponseProduct
import net.crossly.buyer.models.GetMarketProductResponseVariants
...
data class GetMarketProductResponse (
    ...
    @Json(name = "product")
    val product: GetMarketProductResponseProduct,

    @Json(name = "variants")
    val variants: kotlin.collections.List<GetMarketProductResponseVariants>
