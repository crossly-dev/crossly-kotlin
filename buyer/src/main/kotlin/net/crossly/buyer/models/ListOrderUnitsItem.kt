...
import net.crossly.buyer.models.ListOrderUnitsItemIdentifiers
...
data class ListOrderUnitsItem (

    @Json(name = "unitId")
    val unitId: kotlin.String,

    @Json(name = "identifiers")
    val identifiers: kotlin.collections.List<ListOrderUnitsItemIdentifiers>
