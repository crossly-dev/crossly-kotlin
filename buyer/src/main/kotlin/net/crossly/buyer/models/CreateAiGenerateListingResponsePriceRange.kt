...
import net.crossly.buyer.models.CreateAiGenerateListingResponsePriceRangeValue
...
data class CreateAiGenerateListingResponsePriceRange (

    @Json(name = "value")
    val `value`: CreateAiGenerateListingResponsePriceRangeValue,
