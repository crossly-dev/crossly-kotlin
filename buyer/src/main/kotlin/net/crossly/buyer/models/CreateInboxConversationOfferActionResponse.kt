...
import net.crossly.buyer.models.UpdateInboxConversationResponseConversation
...
data class CreateInboxConversationOfferActionResponse (

    @Json(name = "conversation")
    val conversation: UpdateInboxConversationResponseConversation
