...
import net.crossly.buyer.models.GetAnalyticItemResponseItems
...
data class GetAnalyticItemResponse (

    @Json(name = "items")
    val items: kotlin.collections.List<GetAnalyticItemResponseItems>,
