...
import net.crossly.buyer.models.CreateAiExtractReceiptResponseError
...
data class CreateAiExtractReceiptResponse (

    @Json(name = "error")
    val error: CreateAiExtractReceiptResponseError
