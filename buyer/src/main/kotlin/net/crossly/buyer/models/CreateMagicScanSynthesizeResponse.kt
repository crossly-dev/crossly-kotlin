...
import net.crossly.buyer.models.CreateMagicScanSynthesizeResponsePayload
...
data class CreateMagicScanSynthesizeResponse (

    @Json(name = "draftId")
    val draftId: kotlin.String,

    @Json(name = "payload")
    val payload: CreateMagicScanSynthesizeResponsePayload
