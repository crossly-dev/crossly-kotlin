...
import net.crossly.buyer.models.CreateListingImportByUrlResponseListing
...
data class CreateListingImportByUrlResponse (

    @Json(name = "outcome")
    val outcome: kotlin.String,

    @Json(name = "listing")
    val listing: CreateListingImportByUrlResponseListing? = null
