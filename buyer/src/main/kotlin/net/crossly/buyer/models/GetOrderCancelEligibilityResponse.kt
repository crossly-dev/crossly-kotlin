 ...
 *
 * @param eligible 
 * @param eligibleCancelReason 
 * @param failureReason 
 * @param source 
 */

data class GetOrderCancelEligibilityResponse (

    @Json(name = "eligible")
    val eligible: kotlin.Boolean,

    @Json(name = "eligibleCancelReason")
    val eligibleCancelReason: kotlin.collections.List<kotlin.Any>,

    @Json(name = "failureReason")
    val failureReason: kotlin.collections.List<kotlin.Any>,
