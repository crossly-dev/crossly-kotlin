...
import net.crossly.buyer.models.CreateListingCheckDuplicateResponseMatches
...
data class CreateListingCheckDuplicateResponse (

    @Json(name = "matches")
    val matches: kotlin.collections.List<CreateListingCheckDuplicateResponseMatches>
