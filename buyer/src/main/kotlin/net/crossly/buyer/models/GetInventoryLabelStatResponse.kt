...
import net.crossly.buyer.models.GetInventoryLabelStatResponseLabels
...
data class GetInventoryLabelStatResponse (

    @Json(name = "labels")
    val labels: kotlin.collections.List<GetInventoryLabelStatResponseLabels>
