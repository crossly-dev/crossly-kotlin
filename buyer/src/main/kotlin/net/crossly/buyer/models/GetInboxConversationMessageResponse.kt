...
import net.crossly.buyer.models.GetInboxConversationMessageResponseMessages
...
data class GetInboxConversationMessageResponse (

    @Json(name = "messages")
    val messages: kotlin.collections.List<GetInboxConversationMessageResponseMessages>
