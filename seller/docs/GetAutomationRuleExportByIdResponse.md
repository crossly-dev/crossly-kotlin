...
**schemaVersion** | [**java.math.BigDecimal**](java.math.BigDecimal.md) |  | 
...
**dollarSchema** | **kotlin.String** | Optional reference to the public schema URL — purely cosmetic. |  [optional]
